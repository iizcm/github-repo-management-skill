...
| Field | Value |
| --- | --- |
| **Name** | `github-repo-management-skill` |
...
cp -r github/github-repo-management ~/.hermes/skills/github/github-repo-management/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/github-repo-management-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/github-repo-management-skill.git ~/.hermes/skills/github/github-repo-management/
```
...
```text
skill_view(name="github/github-repo-management")
```
...
```text
Use the github repo management skill to <describe your specific task here>
```
...
```text
Gunakan skill github repo management untuk <deskripsikan tugas spesifik Anda di sini>
```
